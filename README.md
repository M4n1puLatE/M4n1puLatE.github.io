...
# 个人介绍
>比起循规蹈矩，我更喜欢富有创造力的工作，想要做一些别人没有试过、没有做过、没有想过的东西。
>我喜欢那种创造一个新事物和解决问题的过程。
...
>计算机技术是在发展变化的，但我喜欢学习更前沿的技术，这让我觉得有动力和目标，也是让自己变得更强的最好方式。我喜欢掌握一个新技术后立即落地一个小样代码，去检验我对新技术的掌握。像我在学习C++的boost.ASIO时就是这样，花了30分钟左右学习了基础的设计思想，然后实现了一个服务端单线程上下文切换的简易TCP clients-server 结构的客户端程序。并迅速基于问题完善了一个简易的传输协议。
